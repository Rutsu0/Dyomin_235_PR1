...
public class HelloApplication extends Application {
    ...
    private JOptionPane JOptionalPane;
    ...
    private Scene createScene1() {
        ...
        calcButton.setOnAction(www->{
            try {
                ...
                int s=4/a;
                resultLavel.setText("периметр квадрата: " +s);
            }
            catch (ArithmeticException e)
            {
                resultLavel.setText("Деление на ноль");
            }
            finally {
                JOptionalPane.showMessageDialog(null, "Значение вычислено");
            }
        });
        ...
        VBox root=new VBox(20, titleLabel,root1,calcButton,resultLavel,root2);
